              ...
              child: FutureBuilder<List<Map<String, dynamic>>>(
                ...
                builder: (context, snapshot) {
                  ...
                  if (historial.isEmpty) {
                    return const Center(
                      child: Text(
                        'No tienes pedidos en tu historial aún.',
                        ...
                        child: Column(
                          ...
                          children: [
                            ListTile(
                              ...
                              subtitle: Text(
                                servicio['observacion'] ?? 'Sin notas.',
                              ),
                              trailing: Column(
                                mainAxisAlignment: MainAxisAlignment.center,
                              ...
                              Padding(
                                ...
                                child: servicio['calificacion'] == null
                                    ? InkWell(
                                        onTap: () {
                                          Navigator.pop(context);
                                          _mostrarMenuCalificacion(servicio);
                                        },
                                        child: Container(
                                          padding: const EdgeInsets.symmetric(
                                            horizontal: 12,
